...
lblInfo = Label(Tops, font=('Comic Sans MS', 50, 'bold'),
                text="CryptoText \n Encoding Your Words for Privacy",
...
lblMsg = Label(f1, font=('Comic Sans MS', 16, 'bold'),
               text="MESSAGE", bd=16, anchor="w")

lblMsg.grid(row=1, column=0)
# Entry box for the message
txtMsg = Entry(f1, font=('Comic Sans MS', 16),
...
# labels for the key
lblkey = Label(f1, font=('Comic Sans MS', 16, 'bold'),
...
txtkey = Entry(f1, font=('Comic Sans MS', 16),
...
# labels for the mode
lblmode = Label(f1, font=('Comic Sans MS', 16, 'bold'),
                text="MODE(e for encrypt, d for decrypt)",
                bd=16, anchor="w")

lblmode.grid(row=3, column=0)
# Entry box for the mode
txtmode = Entry(f1, font=('Comic Sans MS', 16),
...
lblResult = Label(f1, font=('Comic Sans MS', 16, 'bold'),
                  text="The Result-", bd=16, anchor="w")

lblResult.grid(row=2, column=2)

# Entry box for the result
txtResult = Entry(f1, font=('Comic Sans MS', 16),
